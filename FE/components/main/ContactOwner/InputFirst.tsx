...
import { useFirstMessageMutation } from "redux/api/chat";
...
export default function InputFirst(
    ...
    const [fisrtMessage] = useFirstMessageMutation();
    ...
    const send = () => {
        ...
        .then((e) => {
            setRoom(e.id);
            socket?.emit("sendMessage", { receiverId: receiverId.id, message: message, roomId: e.id});
        })
        .catch((e) => {
